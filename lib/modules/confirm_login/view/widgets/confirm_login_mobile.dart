...
class ConfirmLoginMobileWidget extends StatefulWidget {
  final String email;

  const ConfirmLoginMobileWidget({super.key, required this.email});

  @override
  State<ConfirmLoginMobileWidget> createState() =>
      _ConfirmLoginMobileWidgetState();
}

class _ConfirmLoginMobileWidgetState extends State<ConfirmLoginMobileWidget>
