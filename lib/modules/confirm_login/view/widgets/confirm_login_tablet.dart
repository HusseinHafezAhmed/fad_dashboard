...
class ConfirmLoginTabletWidget extends StatefulWidget {
  final String email;
  const ConfirmLoginTabletWidget({super.key, required this.email});

  @override
  State<ConfirmLoginTabletWidget> createState() =>
      _ConfirmLoginTabletWidgetState();
}

class _ConfirmLoginTabletWidgetState extends State<ConfirmLoginTabletWidget>
